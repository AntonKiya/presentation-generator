  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        "- Prefer modern editorial slide patterns: strong image + structured content, soft cards, metric/stat blocks, and short takeaway items.",
        "- Avoid classic bullet-heavy slides. Use bullets only for concise takeaways, steps, or conclusions.",
        "- For parallel ideas, prefer cards over bullets when the selected slot accepts cards.",
        "- For numeric insights, use cards with a large numeric title such as \"70%\", \"+10%\", \"2050\" and a short explanatory text.",
        "- Use image when it can create a strong visual anchor for the slide.",
        "- Keep cards short: compact title plus one clear supporting sentence.",
        "",
        "Available elements:",
